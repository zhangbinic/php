                    ...
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        ...
                        <div id="itemBox" class="item-box">
                            <div class="item">
                                ...
                                <input type="text" name="username" placeholder="请填写用户名" autocomplete="off" value="mgr"/>
                            </div>
                            <span class="placeholder_copy placeholder_un">请填写用户名</span>
                            <div class="item b0">
                                <i class="icon-login-pwd"></i>
                                <input type="password" name="password" placeholder="请填写密码" autocomplete="off" value="111"/>
                            </div>
