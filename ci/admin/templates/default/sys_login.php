				...
				<div class="login_cont">
                    ...
                    <?php echo form_open('login/do'); ?>
						<table class="form_table">
							...
							<col />
							<tr>
								<th>用户名：</th><td><input autocomplete="off" class="normal" type="text" name="username" alt="请填写用户名" value="admin"/></td>
							</tr>
							<tr>
								<th>密码：</th><td><input class="normal" type="password" name="password" alt="请填写密码" value="111111" /></td>
							</tr>
							<tr>
